...
Public Sub SetCreditor(ByVal Value As String)
...
'Public Sub InitItem(ByVal ID As String, ByVal Doc As String, ByVal LogicalSystem As String, ByVal BTType As String, ByVal AcctType As String, ByVal RefID As String, ByVal HeaderText As String, ByVal CreatedBy As String, ByVal Company As String, ByVal DocDate As String, ByVal TaxDate As String, ByVal Ref1 As String, ByVal Ref2 As String, ByVal Acc As String, ByVal Amount As String, ByVal DebitCredit As String, ByVal DocItemText As String, ByVal TaxCode As String, ByVal ProfitCenter As String, ByVal CreditItemRefItem As String, ByVal CreditItemAmount As String, ByVal CreditItemDebitCredit As String, ByVal ProdTaxCode As String, ByVal ProdTaxClass As String, ByVal ProdTaxAmount As String, ByVal ProdTaxDebitCredit As String, ByVal ProdTaxBaseAmount As String, ByVal Creditor As String, ByVal Devise As String)
    'Me.SetId ID
...
Public Sub DebugPrint()
    ...
    Debug.Print "Creditor: " & Me.GetCreditor
